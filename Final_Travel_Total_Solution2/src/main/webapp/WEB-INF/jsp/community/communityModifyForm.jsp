                    ...
                    <!-- 리뷰 리스트 -->
                     	<article class="blog_item">                        
                           <div class="comment-form">
			                        ...
			                        <form class="form-contact comment_form" action="<c:url value='/communityModify'/>" method="post" id="commentForm">
			                            <div class="row">
			                            	...
			                            	<div class="col-12">
			                                    <div class="form-group">
			                                        <input type="text"  value="${dto.title}" class="form-control" name="title" id="website"  placeholder="Title" autofocus="autofocus">
			                                    </div>
			                                </div>
			                                ...
			                                <div class="col-12">
			                                    <div class="form-group">
			                                        <textarea class="form-control w-100" name="contents" id="comment" cols="30" rows="15" placeholder="Write Comment">${dto.contents}</textarea>
			                                    </div>
			                                </div>
...
<!-- 			                                파일 전송
			                            ...
			                            <!-- 버튼 -->
			                            <div class="form-group">
			                                <button type="submit" class="button button-contactForm btn_1">수정완료</button>
			                                <button type="reset" class="button_reset_sj">취소</button>
			                                <button type="button" onclick="location.href='/community/communityList'" class="button_list_sj">목록</button>
			                            </div>
			                        </form>
			                    </div>
