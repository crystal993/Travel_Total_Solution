                    ...
                    <!-- 리뷰 리스트 -->
                     	<article class="blog_item">                        
                           <div class="comment-form">
			                        ...
			                        <form class="form-contact comment_form" action="/community/addCommunity" method="post" id="commentForm">
			                            <div class="row">
...
<!-- 			                                파일 전송
			                            ...
			                            <div class="form-group">
			                                ...
			                                <button type="button" onclick="location.href='communityList'" class="button_list_sj">목록</button>
			                            </div>
			                        </form>
			                    </div>
