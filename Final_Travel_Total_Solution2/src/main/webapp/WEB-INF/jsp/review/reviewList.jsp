                     	...
                     	<article class="blog_item">                        
                            <div class="blog_details">
                                <a class="d-inline-block" href="reviewDetail?postNo=${dto.postNo}" title="${dto.postNo}리뷰 조회">
                                    <h2>${dto.title}</h2>
                                    <h5>${dto.creationDate}</h5>
                                </a>
                                <p>${dto.contents}</p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="far fa-user"></i>${dto.memberId}</a></li>
                                    <li><a href="#"><%-- <input type="hidden" name="views" value="${dto.views}">조회수   </i>${dto.views} --%></a></li>
                                </ul>
                            </div>
                        </article>
                     </c:forEach>   
					...
					<!-- 페이징 기능 -->
                     <nav class="blog-pagination justify-content-center d-flex">
                            ...
                            <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="num">
				        		<li class="page-item">
				        			<a class="page-link" href='<c:url value="/review/reviewList?page=${num}"/>'>${num}</a>
				        		</li>
				    		</c:forEach>
                    	...
                    	<aside class="single_sidebar_widget search_widget">
                            <form action="#">
                                <button type="button" class="button rounded-0 primary-bg text-white w-100 btn_1"
                                   onclick="location.href='/review/reviewWritePage'" >리뷰 작성하기</button>
                            </form>
                        </aside>
