							...
							<c:choose>
									...
									<c:when test="${dto.memberId == sessionId}">
								        ...
								        <div class="form-group" style="text-align:right;">
									        <button type="button" class="button_modify_sj" onclick="location.href='reviewModifyForm?postNo=${dto.postNo}'" >수정</button>
											<button type="button" class="button_reset_sj" onclick="location.href='reviewDelete?postNo=${dto.postNo}'" >삭제</button>
											<button type="button"  class="button_list_sj" onclick="location.href='/review/reviewList'" >목록</button>
										</div>
