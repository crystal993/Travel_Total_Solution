...
<!-- Required meta tags -->
    ...
    <!-- 여행 사이트 css -->
    <link rel="icon" href="img/tts_logo.png">
    <!-- Bootstrap CSS -->
                ...
                <div class="row align-items-center ">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            <a class="navbar-brand" href="/main"> <img src="img/tts_logo.png" alt="logo" style="width:90px; height:100px;"> </a>
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <a class="dropdown-item" href="/member/myInfo">MyInfo</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                            <a class="dropdown-item" href="review/reviewList">리뷰게시판</a>
                                            <a class="dropdown-item" href="community/communityList">동행게시판</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <c:forEach var="dto" items="${list}">
                        <article class="blog_item">
                            <div class="blog_details">
                                <a class="d-inline-block" href="reviewDetail?postNo=${dto.postNo}" title="${dto.postNo}리뷰 조회">
                                    <h2>${dto.title}</h2>
                                </a>
                                <p>${dto.contents}</p>
