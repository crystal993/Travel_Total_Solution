                    ...
                    <!-- 내 정보 -->
                     	<article class="blog_item">                        
                           <div class="comment-form">
			                        ...
			                        <form action="<c:url value='/myInfoUpdate'/>"  class="form-contact comment_form" method="post" id="commentForm">
			                        ...
			                        <br><br><br>
			                            ...
			                            <div class="row">
			                            	...
			                            	<div class="col-12">
			                                    <div class="form-group">
			                                        <input type="password" class="form-control" name="memberPw" value="${dto.memberPw}" 
			                                         id="website"  autofocus="autofocus">
			                                    </div>
			                                </div>
			                                ...
			                                <div class="col-12">
			                                    <div class="form-group">
			                                        <input type="mobile" class="form-control" name="mobile" value="${dto.mobile}" 
			                                        id="website" autofocus="autofocus">
			                                    </div>
			                                </div>
			                            ...
			                            <div class="form-group">
			                                ...
			                                class="button button-contactForm btn_1">수정</button>
