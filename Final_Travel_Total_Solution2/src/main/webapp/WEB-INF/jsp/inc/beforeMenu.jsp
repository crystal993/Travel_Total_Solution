...
<!--::header part start::-->
   <header class="main_menu" style="background-color:white;">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            ...
                            <div class="collapse navbar-collapse main-menu-item justify-content-center"
                                ...
                                <ul class="navbar-nav" style="text-align:right; margin-right: -600px;">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" onclick="location.href='/member/loginjoinForm'">Login/Join</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" onclick="location.href='/review/reviewList'">Review</a>
                                    </li>
